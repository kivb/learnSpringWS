 ...
 *       &lt;sequence>
 *         &lt;element name="CourseDetails" type="{http://saras.lbl.gov/courses}CourseDetailsType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllCourseDetailsResponse {
    ...
    protected List<CourseDetailsType> courseDetails;
     ...
     * 
     */
    public List<CourseDetailsType> getCourseDetails() {
        if (courseDetails == null) {
            courseDetails = new ArrayList<CourseDetailsType>();
        }
